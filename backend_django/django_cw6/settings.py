"""
Django settings for django_cw6 project.
...
WSGI_APPLICATION = "django_cw6.wsgi.application"
...
DJOSER = {
        'SERIALIZERS': {
            ...
            'users': 'users.serializers.CurrentUserSerializer',
